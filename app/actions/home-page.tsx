...
export function HomePage() {
  return () => <Document title="Embeddable Event Photo Gallery Remix Component | Qrati Connect" head={<HomeHead />}><CookieConsentBanner /><ThemeButton /><main mix={css({ minHeight: '100vh', padding: '64px 20px', color: '#213547', background: 'linear-gradient(180deg,#fffdfb,#fff7f1)', fontFamily: 'Inter,system-ui,sans-serif' })}><header mix={css({ maxWidth: '960px', margin: '0 auto', textAlign: 'center' })}><p mix={css({ color: '#ff4800', fontWeight: 800, letterSpacing: '.18em', textTransform: 'uppercase' })}>Embeddable Remix Gallery SDK</p><h1 mix={css({ fontSize: 'clamp(2.2rem,5vw,4rem)' })}><a href="https://qrati.com">Qrati</a> Connect inside a Remix host site</h1><p>Drop in a live event photo gallery with guest uploads, lightbox, reactions, and contest leaderboards. Remix renders the host page; the web component renders the gallery.</p></header><section aria-label="Interactive Remix Event Gallery" mix={css({ maxWidth: '960px', minHeight: '420px', margin: '48px auto', padding: '16px', border: '2px solid #ff480055', borderRadius: '24px', background: '#fff8' })}><h2>Live Event Photo Gallery Component</h2><qrati-connect organization-id={ORGANIZATION_ID} theme="light" router="hash"></qrati-connect></section><section mix={css({ maxWidth: '960px', margin: '48px auto', textAlign: 'center' })}><p>Event Gallery Features</p><h2>Why Developers Choose Qrati Connect</h2><div mix={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '16px', textAlign: 'left' })}><article mix={css({ padding: '20px', border: '1px solid #8884', borderRadius: '16px' })}><b>🖼️ Live Event Photo Wall</b><p>Responsive masonry gallery and full-screen lightbox.</p></article><article mix={css({ padding: '20px', border: '1px solid #8884', borderRadius: '16px' })}><b>📸 Guest Media Uploads</b><p>QR uploads with compression and HEIC conversion.</p></article><article mix={css({ padding: '20px', border: '1px solid #8884', borderRadius: '16px' })}><b>⭐ Reactions &amp; Contests</b><p>Emoji reactions, ratings, and live rankings.</p></article><article mix={css({ padding: '20px', border: '1px solid #8884', borderRadius: '16px' })}><b>⚡ Native Web Component</b><p>Use the same element in Remix and other hosts.</p></article></div></section><section mix={css({ maxWidth: '760px', margin: '48px auto' })}><h2>Frequently Asked Questions</h2>{['How do I embed an event photo gallery in Remix?','Can attendees upload photos?','How does Remix handle theme sync?','Does it support dark mode?','Can I run photo contests?'].map((question, i) => <details key={question} open={i === 0} mix={css({ margin: '12px 0', padding: '16px', border: '1px solid #8884', borderRadius: '12px' })}><summary>{question}</summary><p>Yes. Qrati Connect provides this capability when enabled in your organization settings.</p></details>)}</section><section mix={css({ maxWidth: '760px', margin: '48px auto', padding: '32px', border: '1px solid #ff480055', borderRadius: '20px', textAlign: 'center' })}><h2>Host Your Event on Qrati. <span>Stream the Live Gallery on Your Website.</span></h2><p>Create your event, let attendees upload, then embed the live gallery in your Remix app.</p><a href="https://qrati.com">Host Your Event on Qrati →</a></section><footer mix={css({ maxWidth: '960px', margin: '48px auto 0', display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap', color: '#6b7280' })}><img src="https://assets.qrati.com/images/qrati-connect-logo-square.png" alt="Qrati Connect logo" width="36" /><b><span>Qrati</span> Connect</b><a href="https://qrati.com/pricing">Pricing</a><span>© 2026 Qrati Labs. All rights reserved.</span></footer></main></Document>
}
